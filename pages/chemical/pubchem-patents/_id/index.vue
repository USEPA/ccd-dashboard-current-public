  ...
  <div>
    <div class="row pr-4">
      <div class="col-sm-12 h2 pl-4">
        <ccte-help-text
          data-cy="PubChemPatentsHeader"
          label-type="span"
          heading-text="Literature - PubChem Patents"
          help-key="PubChemPatentsHeader"
        />
      </div>
    </div>
    <div class="row pr-4">
      <div class="col-sm-12 h2">
        <div class="embed-responsive embed-responsive-16by9 z-depth-1-half leftmargin">
          <iframe class="embed-responsive-item" :src="pubchemPatentsUrl" frameborder="0" />
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  computed: {
    ...
    pubchemPatentsUrl() {
      return `https://pubchem.ncbi.nlm.nih.gov/compound/${this.chemical.dtxsid}#section=Depositor-Supplied-Patent-Identifiers&embed=true`;
    },
  },
  head() {
    return {
      title: `${this.chemical.preferredName} - Publications - PubChem Patents`,
      meta: [],
    };
  },
};
